    ...
    <section className="py-16 bg-white">
      ...
      >
       ...
       <p>
          ...
          разработку в 2018 году. Презентация метода успешно прошла в феврале
          2018 года в Дубае .
        </p>
        <img
						src='/images/photo_2025-03-30_12-40-26.jpg'
						alt='Схема метода СК'
            className="object-cover object-top rounded-2xl shadow-sm w-1/2"
          />
        </div>
        <div className="flex gap-12">
        ...
        <p>
          ...
          рекомендации Профессора Васильевой Л. В 2024 году были проведен первый
          семинар в г. Барнаул.
        </p>
        <img
        ...
        <p>
        А также проведены мастер-классы в Москве и Федеральном Курорте Белокуриха.
