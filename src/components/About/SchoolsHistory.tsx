...
export const SchoolsHistory = () => {
	return (
		<section className='py-16 bg-white'>
			<motion.div
				className='max-w-5xl mx-auto text-gray-700 mb-10 text-lg space-y-8'
			...
			>
				...
				<div className='flex max-lg:flex-wrap gap-12'>
					<p>
						...
						первый мастер-класс в городе Барнауле.
					</p>
					<img
				...
				<p>
					...
					а также ряд семинаров с углубленным изучением вопросов диагностики и
					коррекции биохимических, висцеральных проблем и дисбаланса, связанного
